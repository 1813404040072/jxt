...
public class OrderItemResourceIT {
    ...
    private static final Long DEFAULT_ORDER_DATE = 1L;
    private static final Long UPDATED_ORDER_DATE = 2L;
    ...
    private static final BigDecimal DEFAULT_ADJUSTED = new BigDecimal(1);
    private static final BigDecimal UPDATED_ADJUSTED = new BigDecimal(2);
    ...
    public void createOrderItem() throws Exception {
        ...
        assertThat(testOrderItem.getAdjusted()).isEqualTo(DEFAULT_ADJUSTED);
    ...
    public void getAllOrderItems() throws Exception {
        ...
        restOrderItemMockMvc.perform(get("/api/order-items?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].orderDate").value(hasItem(DEFAULT_ORDER_DATE.intValue())))
            .andExpect(jsonPath("$.[*].productId").value(hasItem(DEFAULT_PRODUCT_ID.intValue())))
            .andExpect(jsonPath("$.[*].quantity").value(hasItem(DEFAULT_QUANTITY.intValue())))
            .andExpect(jsonPath("$.[*].adjusted").value(hasItem(DEFAULT_ADJUSTED.intValue())))
    ...
    public void getOrderItem() throws Exception {
        ...
        restOrderItemMockMvc.perform(get("/api/order-items/{id}", orderItem.getId()))
            ...
            .andExpect(jsonPath("$.orderDate").value(DEFAULT_ORDER_DATE.intValue()))
            .andExpect(jsonPath("$.productId").value(DEFAULT_PRODUCT_ID.intValue()))
            .andExpect(jsonPath("$.quantity").value(DEFAULT_QUANTITY.intValue()))
            .andExpect(jsonPath("$.adjusted").value(DEFAULT_ADJUSTED.intValue()))
    ...
    public void updateOrderItem() throws Exception {
        ...
        assertThat(testOrderItem.getAdjusted()).isEqualTo(UPDATED_ADJUSTED);
