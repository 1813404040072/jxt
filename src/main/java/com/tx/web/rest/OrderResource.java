...
/**
 * REST controller for managing {@link com.tx.domain.Order}.
 */
@RestController
@RequestMapping("/api")
public class OrderResource {
    ...
    public ResponseEntity<List<OrderDTO>> query(OrderDTO dto) {
        log.debug("REST request to get a page of Orders");
        System.out.println("paging....." + dto.getPage());
        Page<OrderDTO> page = orderService.query(dto);
